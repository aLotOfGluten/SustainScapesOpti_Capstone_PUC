...
# Id (var):
# Identifies the test from other runs of the same algorithm
...
# Problem (input):
# File path of the .dat with complete problem
...
# Cell ids (input):
# Csv file with the cells ids and the municipality they belong to
